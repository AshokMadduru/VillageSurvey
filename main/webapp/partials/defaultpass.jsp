...
<html>
<head>
<title>Village Survey - Gateway</title>
			...
			<form action="javascript:void(0);">
				...
				<div class="input-group input-group-lg">
					<span class="input-group-addon"><span
						...
						id="dpassword" type="password" class="form-control"
						placeholder="Password" required>
				</div>
				<br />
				<button id="Login" type="submit"
					class="btn btn-primary btn-lg btn-block" value = "password123"
					onClick='validateDefaultPassword();'>Submit</button>
			</form>
		</div>
